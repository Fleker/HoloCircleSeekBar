...
public class HoloCircleSeekBar extends View {
    ...
    private void initAttributes(TypedArray a) {
        mColorWheelStrokeWidth = a.getInteger(R.styleable.HoloCircleSeekBar_wheel_size, 16);
        mPointerRadius = a.getInteger(R.styleable.HoloCircleSeekBar_pointer_size, 48);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mColorWheelRectangle, start_arc /* + 270 */,/*
                                                                    * (arc_finish_radians) > (end_wheel) ? end_wheel -
                                                                    * (start_arc) :
...
//                if ((start_arc <= 10 && (valueDegree > 0 || valueDegree>350)) || (start_arc > 10 && valueDegree < start_arc - 10))
